			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="row">
					<div class="ed_event_single_address_info ed_toppadder50 ed_bottompadder50">
						...
						<p>Telefono: <span>0992309791</span></p>
						<p>Email: <a href="#">holamundo@gmail.com</a></p>
						<p>WEB: <a href="https://mecanicaautomundo.blogspot.com/">https://automundo.blogspot.com/</a></p>
					</div>
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-6">
