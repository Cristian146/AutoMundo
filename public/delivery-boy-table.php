...
<section class="content-header">
    <h1>Vendedor /<small><a href="home.php"><i class="fa fa-home"></i> Home</a></small></h1>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-md-6">
            <?php if($permissions['delivery_boys']['create']==0){?>
                <div class="alert alert-danger">No tienes permiso para crear vendedor</div>
            <?php } ?>
            
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Añadir vendedor</h3>
        ...
        <div class="col-xs-6">
            ...
            <?php } else { ?>
                <div class="alert alert-danger">No tienes permiso para ver vendedor</div>
            <?php }?>
        </div>
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Editar vendedor</h4>
                        </div>
                        
                        <div class="modal-body">
                            <?php if($permissions['delivery_boys']['update']==0){?>
                                <div class="alert alert-danger">No tienes permiso para actualizar vendedor</div>
                            <?php } ?>
                            <div class="box-body">
  ...
  <script>
    ...
    <script>
      ...
      if( $("#add_form").validate().form() ){
            if(confirm('¿Estás seguro? ¿Quieres agregar vendedor?')){
            $.ajax({
            type:'POST',
            url: $(this).attr('action'),
            data:formData,
 ...
 <script>
     $(document).on('click','.delete-delivery-boy',function(){
            if(confirm('¿Estás seguro? Quiere eliminar vendedor.')){
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        if(result==2){
                            alert('No tienes permiso para eliminar vendedor');
                        }
                        if(result==1){
                            alert('¡Error! El vendedor no se pudo eliminar.');
                        }
                        if(result==3){
                            alert('No puedes eliminar a este vendedor.');
                        }
