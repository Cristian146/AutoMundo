...
if(isset($_POST['add_delivery_boy']) && $_POST['add_delivery_boy']==1){
    ...
    if($permissions['delivery_boys']['create']==0){
       echo '<label class="alert alert-danger">No tienes permiso para crear vendedor</label>';
       return false; 
    }
    ...
    if($db->sql($sql)){
        echo '<label class="alert alert-success">Vendedor añadido con exito!</label>';
    }else{
...
if(isset($_POST['update_delivery_boy']) && $_POST['update_delivery_boy']==1){
    ...
    if($permissions['delivery_boys']['update']==0){
       echo '<label class="alert alert-danger">No tienes permiso para actualizar vendedor</label>';
       return false; 
    }
    $id = $db->escapeString($_POST['delivery_boy_id']);
    if($id==104){
       echo '<label class="alert alert-danger">Lo siento, no puedes actualizar este vendedor</label>';
       return false; 
    }
