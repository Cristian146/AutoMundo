            ...
            <div class="box box-primary">
                ...
                <form id="system_configurations_form"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="delivery_charge">comicion de vendedor (<?=$settings['currency']?>)</label>
                        ...
                        <div class="form-group">
                            <label for="">Bono vendedor (%)</label>
                            <input type="number" class="form-control" name="delivery-boy-bonus-percentage" value="<?=$data['delivery-boy-bonus-percentage']?>" placeholder='Bono vendedor' />
                        </div>
