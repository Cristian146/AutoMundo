    ...
    if(isset($_POST['btnEdit'])){
        if($permissions['products']['update']==1){
            ...
            if(isset($_FILES['other_images']) && ($_FILES['other_images']['size'][0] > 0 )){
                ...
                if (isset($_POST['insert_packate_measurement']) && isset($_POST['insert_packate_price']) 
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <label for="type">Tipo</label><?php echo isset($error['type']) ? $error['type'] : '';?>
                    <div class="form-group">
                      <label class="radio-inline"><input type="radio" name="type"  id="packate" value="packet" <?=($res[0]['type']=="packet")?"checked":""; ?> >Paquete</label>
                            ...
                            <input type="hidden" class="form-control" name="product_variant_id[]" id="product_variant_id" value='<?=$row['product_variant_id'];?>'/>
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
                                        <label for="price">Iva  (<?=$settings['currency']?>):</label><input type="text" class="form-control" name="packate_price[]" id="packate_price"  value='<?=$row['price'];?>' required />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group packate_div">
